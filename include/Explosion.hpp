...
public:
    ...
    explicit Explosion(const glm::vec2& pos, Type type = Type::ENEMY) {
        ...
        if (type == Type::ENEMY) {
            ...
            frames = {
                RESOURCE_DIR"/Image/Character/explosion_player_1.png",
                RESOURCE_DIR"/Image/Character/explosion_player_2.png",
                RESOURCE_DIR"/Image/Character/explosion_player_3.png",
                RESOURCE_DIR"/Image/Character/explosion_player_4.png",
            };
            m_Transform.scale = {0.7f, 0.7f};
        }

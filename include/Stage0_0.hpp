...
public:
    Stage0_0() {
        // 測試路徑：從右上角飛入，繞一個彎，到達編隊位置
        /*m_Path = {
            { { {300.0f, 500.0f}, {300.0f, 200.0f}, {100.0f, 100.0f}, {0.0f, 50.0f} } },
            { { {0.0f, 50.0f}, {-100.0f, 50.0f}, {-100.0f, 100.0f}, {-50.0f, 100.0f} } }
        };*/
        ...
        for (int i = 0; i < 5; i++) {
            ...
            std::vector<Enemy::BezierPath> path = {
                { { {300.0f, 500.0f}, {300.0f, 200.0f}, {100.0f, 100.0f}, {0.0f, 50.0f} } },
                { { {0.0f, 50.0f}, {-100.0f, 50.0f}, {-100.0f, 100.0f}, fPos } }
            };
